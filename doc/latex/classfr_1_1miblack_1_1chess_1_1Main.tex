...
Collaboration diagram for fr.\-miblack.\-chess.\-Main\-:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=198pt]{classfr_1_1miblack_1_1chess_1_1Main__coll__graph}
\end{center}
\end{figure}
...
\item 
fr/miblack/chess/{\bf Main.\-java}\end{DoxyCompactItemize}
